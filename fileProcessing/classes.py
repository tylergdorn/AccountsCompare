...
class MissingResult:
    ...
    def __str__(self):
       return f'{self.recordType} invoice number {self.record.invoiceNo} not found in {self.otherType}'
...
class MismatchResult:
    ...
    def __str__(self):
        return f'{self.recordType} Invoice number {self.record.invoiceNo} amount {self.record.totalDue} does not match {self.otherType} amount {self.other.totalDue}'
